/* clase tarea y sus constructores */
class Tarea {
...
            this.tickets = [];
            localStorage.removeItem('audi_tareas');
            this.render();
        }
    }
...
                        <button class="btn-sm toggle-btn" onclick="app.toggleEstado(${t.id})">
                            <i class="fa-solid fa-check"></i>
                        </button>
                        <button class="btn-sm edit-btn" onclick="app.editarTicket(${t.id})">
                            <i class="fa-solid fa-pen"></i>
                        </button>
                        <button class="btn-sm delete-btn" onclick="app.eliminarTicket(${t.id})">
